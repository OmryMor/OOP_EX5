...
public class RegexConstants {
    public static final String COMMENT_REGEX = "^\\s*$|^\\s*//",
            ...
            VARIABLE_DECLARATION_REGEX = "^(final\\s+)?(int|double|String|boolean|char)\\s+((([A-Za-z][A-Za-z0-9_]*|_[A-Za-z0-9][A-Za-z0-9_]*)((\\s*[=]\\s*)([-+]?[\\d]*[.]?[\\d]+|\".*\"|'.'|true|false|([A-Za-z][A-Za-z0-9_]*|_[A-Za-z0-9][A-Za-z0-9_]*)))?\\s*,\\s*)*([A-Za-z][A-Za-z0-9_]*|_[A-Za-z0-9][A-Za-z0-9_]*)((\\s*[=]\\s*)([-+]?[\\d]*[.]?[\\d]+|\".*\"|'.'|true|false|([A-Za-z][A-Za-z0-9_]*|_[A-Za-z0-9][A-Za-z0-9_]*)))?)\\s*;",
